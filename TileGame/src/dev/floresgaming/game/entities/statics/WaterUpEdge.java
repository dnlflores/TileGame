...
public class WaterUpEdge extends StaticEntity{
	private Animation water;
	
	public WaterUpEdge(Handler handler, float x, float y) {
		super(handler, x, y, Tile.TILE_WIDTH, Tile.TILE_HEIGHT);
		
		water = new Animation(DEFAULT_WATER_ANIMATION_SPEED, Assets.water_upEdge);
	}
