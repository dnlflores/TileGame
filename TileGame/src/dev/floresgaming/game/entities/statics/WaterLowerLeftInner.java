...
public class WaterLowerLeftInner extends StaticEntity{
	private Animation water;
	
	public WaterLowerLeftInner(Handler handler, float x, float y) {
		super(handler, x, y, Tile.TILE_WIDTH, Tile.TILE_HEIGHT);
		
		water = new Animation(DEFAULT_WATER_ANIMATION_SPEED, Assets.water_lowerLeftInner);
	}
