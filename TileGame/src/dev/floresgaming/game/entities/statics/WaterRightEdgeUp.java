...
public class WaterRightEdgeUp extends StaticEntity{
	private Animation water;
	
	public WaterRightEdgeUp(Handler handler, float x, float y) {
		super(handler, x, y, Tile.TILE_WIDTH * 1, Tile.TILE_HEIGHT * 1);
		
		water = new Animation(DEFAULT_WATER_ANIMATION_SPEED, Assets.water_rightEdge_up);
	}
