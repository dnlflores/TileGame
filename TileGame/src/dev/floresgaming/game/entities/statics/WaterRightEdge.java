...
public class WaterRightEdge extends StaticEntity{
	private Animation water;
	
	public WaterRightEdge(Handler handler, float x, float y) {
		super(handler, x, y, Tile.TILE_WIDTH * 1, Tile.TILE_HEIGHT * 3);
		
		water = new Animation(DEFAULT_WATER_ANIMATION_SPEED, Assets.water_rightEdge);
	}
