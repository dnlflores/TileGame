...
public class MasterBall extends Item{
	public MasterBall(Handler handler, float x, float y) {
		super(Assets.masterball, "MasterBall", 2, Tile.TILE_WIDTH, Tile.TILE_HEIGHT);
	...
	public void render(Graphics g){
		g.drawImage(Assets.masterball, (int) (x - handler.getGameCamera().getxOffset()),
